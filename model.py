...
transformer_configs = {
    ...
    "nsql-6B": dict(block_size=2048, vocab_size=51200, intermediate_size=4096, n_layer=33, n_head=16, dim=4096, rotary_dim=64),
    "nsql-2B": dict(block_size=2048, vocab_size=51200, intermediate_size=4096, n_layer=32, n_head=16, dim=2560, rotary_dim=64),
